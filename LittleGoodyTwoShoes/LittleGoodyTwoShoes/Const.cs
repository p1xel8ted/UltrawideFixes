...
{
    internal const string GameTitleVo = "GameTitleVO";
    internal const string TitleUI = "TitleUI";
    internal const string SplashCanvas = "SplashCanvas";
    ...
    internal const string Fader = "Fader";
    internal const string BG = "BG";
    internal const string Bg1 = "bg1";
    internal const string Bg2 = "bg2";
    internal const string CreditsButtonPath = "TitleUI/Buttons/Scroll-Snap/Viewport/Content/Credits";
}