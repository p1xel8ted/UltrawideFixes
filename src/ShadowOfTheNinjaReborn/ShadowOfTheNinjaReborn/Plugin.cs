...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        UseTwentyOneNine = Config.Bind("03. Misc", "Use Real 21:9", false, new ConfigDescription("For users that have a decimal in their aspect, i.e. 21.5:9 (3440x1440), if you're getting white lines, enable this.", null, new ConfigurationManagerAttributes { Order = 97 }));
