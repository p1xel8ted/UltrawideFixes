namespace SorryWereClosed.WindowsAPI;
...
public class WindowPositioner : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        Display.displays[Plugin.DisplayToUse.Value].Activate(res.width, res.height, Plugin.RefreshRate);
    ...
    private static void MoveWindowToDisplay(int displayIndex)
    {
        ...
        var window = FindWindow(null, "Sorry We're Closed");
