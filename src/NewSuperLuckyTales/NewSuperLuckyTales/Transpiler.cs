...
public static class ScreenResolutionsPatch
{
    ...
    {
        yield return AccessTools.Method(typeof(UIResolutionList), nameof(UIResolutionList.OnEnable));
        yield return AccessTools.Method(typeof(GraphicsSettings), nameof(GraphicsSettings.FindNearestValidResolution));
        yield return AccessTools.Method(typeof(GraphicsSettings), nameof(GraphicsSettings.GetSupportedResolutionList));
    }
