...
public static class ScreenResolutionsPatch
{
    ...
    {
        yield return AccessTools.Method(typeof(deviceInfo), nameof(deviceInfo.Awake));
        yield return AccessTools.Method(typeof(fullscreenToggle), nameof(fullscreenToggle.Start));
    }
