...
namespace WinterBurrow.Resolutions;
...
public static class ScreenResolution
{
    ...
    {
        width = ResolutionManager.SelectedResolution.width;
        height = ResolutionManager.SelectedResolution.height;
        fullscreen = IsFullScreen;
        preferredRefreshRate = ResolutionManager.RefreshRate;
    }
    ...
    public static void Screen_SetResolution_Three(ref int width, ref int height, ref FullScreenMode fullscreenMode)
    {
        width = ResolutionManager.SelectedResolution.width;
        height = ResolutionManager.SelectedResolution.height;
        fullscreenMode = DisplayConfig.FullScreenMode.Value;
    }
    ...
    public static void Screen_SetResolution_Five(ref int width, ref int height, ref FullScreenMode fullscreenMode, ref RefreshRate preferredRefreshRate)
    {
        ...
        height = ResolutionManager.SelectedResolution.height;
        fullscreenMode = DisplayConfig.FullScreenMode.Value;
        preferredRefreshRate = ResolutionManager.RefreshRateStruct;
    }
