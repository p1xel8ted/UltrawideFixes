namespace Voidwrought
{
    ...
    public static class ScreenResolutionsPatch
    {
        ...
        {
            yield return AccessTools.Method(typeof(PopulateRefreshRates), nameof(PopulateRefreshRates.Awake));
            yield return AccessTools.Method(typeof(PopulateResolutions), nameof(PopulateResolutions.FillChoices));
            yield return AccessTools.Method(typeof(SettingsInfiniteChoice), nameof(SettingsInfiniteChoice.Load));
            yield return AccessTools.Method(typeof(SettingsMenu), nameof(SettingsMenu.SetFrameRate));
            yield return AccessTools.Method(typeof(SettingsMenu), nameof(SettingsMenu.SetResolution));
        }
