...
public static class ResolutionManager
{
    ...
    /// </summary>
    internal static float GetPreferredAspect(bool dialog)
    {
        var hudAspect = UIConfig.HUDAspect.Value;
        var dlgAspect = UIConfig.DialogAspect.Value;

        var selectedAspect = dialog ? dlgAspect : hudAspect;
        ...
        return HUDAspectValues.TryGetValue(selectedAspect, out var aspectValue) ? aspectValue : CurrentAspect;
    }
