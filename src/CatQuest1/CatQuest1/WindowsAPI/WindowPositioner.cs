namespace CatQuest1.WindowsAPI;
...
public class WindowPositioner : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        Display.displays[Plugin.DisplayToUse.Value].Activate(Plugin.MainWidth, Plugin.MainHeight, Plugin.MaxRefreshRate);
    ...
    private static void MoveWindowToDisplay(int displayIndex)
    {
        ...
        var window = FindWindow(null, "Cat Quest");
