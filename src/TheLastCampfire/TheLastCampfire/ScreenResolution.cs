...
//         Screen.SetResolution(width, height, Plugin.FullScreenModeConfig.Value, Plugin.MaxRefresh);
//     }
//     
//     [HarmonyPrefix]
...
//         // height = Plugin.MainHeight;
//         // fullscreen = Plugin.FullScreenModeConfig.Value == FullScreenMode.ExclusiveFullScreen || Plugin.FullScreenModeConfig.Value == FullScreenMode.FullScreenWindow;
//         Screen.SetResolution(width, height, Plugin.FullScreenModeConfig.Value);
//     }
//     
//     [HarmonyPrefix]
