...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        HeroLight.SettingChanged += (_, _) => { Patches.UpdateHeroSettings(); };
        ...
        HeroLightDonut.SettingChanged += (_, _) => { Patches.UpdateHeroSettings(); };
        ...
        Vignette.SettingChanged += (_, _) => { Patches.UpdateHeroSettings(); };
