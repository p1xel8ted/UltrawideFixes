...
public class Options: MonoBehaviour
{
    ...
    private void Start()
    {
        Plugin.Log.LogWarning("Options Start");
    }
    
    private void OnEnable()
    {
        Plugin.Log.LogWarning("Options OnEnable");
    }
    ...
    void OnGUI()
    {
        ...
        if (!Mathf.Approximately(newSliderValue,SliderValue))
        {
            SliderValue = Mathf.CeilToInt(newSliderValue);
