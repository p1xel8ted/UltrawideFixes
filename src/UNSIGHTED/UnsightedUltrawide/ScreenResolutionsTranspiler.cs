...
public static class ScreenResolutionsTranspiler
{
    ...
    {
        yield return AccessTools.Method(typeof(GlobalGraphicsSettings), nameof(GlobalGraphicsSettings.SetGraphicsSettings));
        yield return AccessTools.Method(typeof(SplashScreenScene), nameof(SplashScreenScene.CheckBestResolution));
    }
