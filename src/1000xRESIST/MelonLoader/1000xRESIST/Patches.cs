...
//     public static void ModalPrompt_Show(ModalPrompt __instance)
//     {
//         //ModalPrompt
...
//     public static void LoadMenu_OnShown(LoadMenu __instance)
//     {
//         //LoadMenu
//         LayoutController.AddLayoutControllerRoot(__instance.transform, LayoutController.LayoutSize.ForceSixteenNine, 0f, false);
...
//     public static void ChapterSelectMenu_OnShown(ChapterSelectMenu __instance)
//     {
//         //ChapterSelectMenu
//         LayoutController.AddLayoutControllerRoot(__instance.transform, LayoutController.LayoutSize.ForceSixteenNine, 0f, false);
...
//     public static void SettingsMenu_OnShown(SettingsMenu __instance)
//     {
//         //SettingsMenu
//         LayoutController.AddLayoutControllerRoot(__instance.transform, LayoutController.LayoutSize.ForceSixteenNine, 0f, false);
...
//     public static void Fade_Awake(Fade __instance)
//     {
//         LayoutController.AddLayoutControllerRoot(__instance.transform, LayoutController.LayoutSize.ForceSixteenNine, 0f, false);
//     }
//
...
//             if (_transposer)
//             {
//                 _transposer.m_FollowOffset = _transposer.m_FollowOffset with
//                 {
//                     x = Mod.OffsetX.Value,
//                     y = Mod.OffsetY.Value,
//                     z = Mod.OffsetZ.Value
...
//     public static void LoadingPanel_Awake(LoadingPanel __instance)
//     {
...
//             __instance.uiScaleMode = Mod.CurrentAspect >= 3.7f ? CanvasScaler.ScaleMode.ScaleWithScreenSize : CanvasScaler.ScaleMode.ConstantPixelSize;
//         }
//
