    ...
    internal void UpdateAspect()
    {
        if (_layoutElement)
        {
            ...
            var width = _size switch
            {
                ...
                LayoutSize.ForceFullScreen => Mathf.RoundToInt(height * Mod.CurrentAspect),
                LayoutSize.ForceSixteenNine => Mathf.RoundToInt(height * Mod.NativeAspect),
        ...
        if (_aspectRatioFitter)
        {
            ...
            {
                LayoutSize.Custom => _customSize,
                LayoutSize.ForceFullScreen => Mod.CurrentAspect,
                LayoutSize.ForceSixteenNine => Mod.NativeAspect,
                _ => Mod.CurrentAspect
            };
