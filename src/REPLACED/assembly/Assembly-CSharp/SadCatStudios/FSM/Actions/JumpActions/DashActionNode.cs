...
// Type: SadCatStudios.FSM.Actions.JumpActions.DashActionNode
...
public class DashActionNode(IntPtr pointer) : ActionNode(pointer)
{
  ...
  {
    Il2CppClassPointerStore<DashActionNode>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "SadCatStudios.FSM.Actions.JumpActions", nameof (DashActionNode));
    IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<DashActionNode>.NativeClassPtr);
    DashActionNode.NativeMethodInfoPtr_CreateInstance_Public_Virtual_IFSMObject_FSMGraphObject_StateController_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DashActionNode>.NativeClassPtr, 100673936);
    DashActionNode.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DashActionNode>.NativeClassPtr, 100673937);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 110913, XrefRangeEnd = 110917, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
