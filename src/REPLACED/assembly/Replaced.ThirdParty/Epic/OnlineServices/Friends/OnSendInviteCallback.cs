...
// Type: Epic.OnlineServices.Friends.OnSendInviteCallback
...
public sealed class OnSendInviteCallback(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnSendInviteCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Friends", nameof (OnSendInviteCallback));
    OnSendInviteCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallback>.NativeClassPtr, 100670519);
    OnSendInviteCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_SendInviteCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallback>.NativeClassPtr, 100670520);
    OnSendInviteCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_SendInviteCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallback>.NativeClassPtr, 100670521);
    OnSendInviteCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnSendInviteCallback>.NativeClassPtr, 100670522);
  }
