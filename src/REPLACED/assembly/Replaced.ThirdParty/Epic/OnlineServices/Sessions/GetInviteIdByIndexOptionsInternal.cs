...
public struct GetInviteIdByIndexOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Sessions", nameof (GetInviteIdByIndexOptionsInternal));
    ...
    GetInviteIdByIndexOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr, 100665477);
    GetInviteIdByIndexOptionsInternal.NativeMethodInfoPtr_set_Index_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr, 100665478);
    GetInviteIdByIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_GetInviteIdByIndexOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr, 100665479);
    GetInviteIdByIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr, 100665480);
    GetInviteIdByIndexOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetInviteIdByIndexOptionsInternal>.NativeClassPtr, 100665481);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377766, XrefRangeEnd = 377772, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 377778, RefRangeEnd = 377779, XrefRangeStart = 377772, XrefRangeEnd = 377778, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377779, XrefRangeEnd = 377782, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377782, XrefRangeEnd = 377789, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
