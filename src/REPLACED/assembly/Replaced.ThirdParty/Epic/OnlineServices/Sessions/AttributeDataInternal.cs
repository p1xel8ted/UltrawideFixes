...
public struct AttributeDataInternal
{
  ...
  {
    Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Sessions", nameof (AttributeDataInternal));
    ...
    AttributeDataInternal.NativeMethodInfoPtr_get_Key_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665327);
    AttributeDataInternal.NativeMethodInfoPtr_set_Key_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665328 /*0x060007F0*/);
    AttributeDataInternal.NativeMethodInfoPtr_get_Value_Public_get_AttributeDataValue_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665329);
    AttributeDataInternal.NativeMethodInfoPtr_set_Value_Public_set_Void_AttributeDataValue_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665330);
    AttributeDataInternal.NativeMethodInfoPtr_Set_Public_Void_AttributeData_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665331);
    AttributeDataInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665332);
    AttributeDataInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AttributeDataInternal>.NativeClassPtr, 100665333);
  }

  public unsafe string Key
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377181, XrefRangeEnd = 377185, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
    ...
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377185, XrefRangeEnd = 377189, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377189, XrefRangeEnd = 377195, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
    ...
    [CallerCount(2), CachedScanResults(RefRangeStart = 377201, RefRangeEnd = 377203, XrefRangeStart = 377195, XrefRangeEnd = 377201, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377203, XrefRangeEnd = 377208, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377208, XrefRangeEnd = 377215, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 377215, XrefRangeEnd = 377225, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
