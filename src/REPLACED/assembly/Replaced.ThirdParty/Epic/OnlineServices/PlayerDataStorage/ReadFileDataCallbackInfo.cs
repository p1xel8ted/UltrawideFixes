...
// Type: Epic.OnlineServices.PlayerDataStorage.ReadFileDataCallbackInfo
...
public class ReadFileDataCallbackInfo(System.IntPtr pointer) : Il2CppSystem.Object(pointer)
{
  ...
  {
    Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (ReadFileDataCallbackInfo));
    ...
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_ClientData_Public_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667834);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_ClientData_Private_set_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667835);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667836);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_LocalUserId_Private_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667837);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_Filename_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667838);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_Filename_Private_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667839);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_TotalFileSizeBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667840);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_TotalFileSizeBytes_Private_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667841);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_IsLastChunk_Public_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667842);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_IsLastChunk_Private_set_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667843);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_get_DataChunk_Public_get_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667844);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_set_DataChunk_Private_set_Void_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667845);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_GetResultCode_Public_Virtual_Final_New_Nullable_1_Result_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667846);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_Set_Internal_Void_Nullable_1_ReadFileDataCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667847);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667848);
    ReadFileDataCallbackInfo.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfo>.NativeClassPtr, 100667849);
  }
  ...
  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 385115, RefRangeEnd = 385116, XrefRangeStart = 385077, XrefRangeEnd = 385115, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 385116, XrefRangeEnd = 385121, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
