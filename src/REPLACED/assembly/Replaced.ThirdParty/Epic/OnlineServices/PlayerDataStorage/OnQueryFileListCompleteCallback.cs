...
public sealed class OnQueryFileListCompleteCallback(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (OnQueryFileListCompleteCallback));
    OnQueryFileListCompleteCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100667701);
    OnQueryFileListCompleteCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_QueryFileListCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100667702);
    OnQueryFileListCompleteCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_QueryFileListCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100667703);
    OnQueryFileListCompleteCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnQueryFileListCompleteCallback>.NativeClassPtr, 100667704);
  }
