...
public class ReadFileOptions(System.IntPtr pointer) : Il2CppSystem.Object(pointer)
{
  ...
  {
    Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (ReadFileOptions));
    ...
    ReadFileOptions.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667857);
    ReadFileOptions.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667858);
    ReadFileOptions.NativeMethodInfoPtr_get_Filename_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667859);
    ReadFileOptions.NativeMethodInfoPtr_set_Filename_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667860);
    ReadFileOptions.NativeMethodInfoPtr_get_ReadChunkLengthBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667861);
    ReadFileOptions.NativeMethodInfoPtr_set_ReadChunkLengthBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667862);
    ReadFileOptions.NativeMethodInfoPtr_get_ReadFileDataCallback_Public_get_OnReadFileDataCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667863);
    ReadFileOptions.NativeMethodInfoPtr_set_ReadFileDataCallback_Public_set_Void_OnReadFileDataCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667864);
    ReadFileOptions.NativeMethodInfoPtr_get_FileTransferProgressCallback_Public_get_OnFileTransferProgressCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667865);
    ReadFileOptions.NativeMethodInfoPtr_set_FileTransferProgressCallback_Public_set_Void_OnFileTransferProgressCallback_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667866);
    ReadFileOptions.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptions>.NativeClassPtr, 100667867);
  }
