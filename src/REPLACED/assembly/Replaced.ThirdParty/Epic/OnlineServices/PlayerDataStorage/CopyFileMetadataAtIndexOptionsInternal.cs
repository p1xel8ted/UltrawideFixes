...
public struct CopyFileMetadataAtIndexOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (CopyFileMetadataAtIndexOptionsInternal));
    ...
    CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100667521);
    CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_set_Index_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100667522);
    CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_CopyFileMetadataAtIndexOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100667523);
    CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100667524);
    CopyFileMetadataAtIndexOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataAtIndexOptionsInternal>.NativeClassPtr, 100667525);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384006, XrefRangeEnd = 384010, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384010, XrefRangeEnd = 384014, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384014, XrefRangeEnd = 384020, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384020, XrefRangeEnd = 384024, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
