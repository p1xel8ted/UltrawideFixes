...
public struct ReadFileOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (ReadFileOptionsInternal));
    ...
    ReadFileOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667868);
    ReadFileOptionsInternal.NativeMethodInfoPtr_set_Filename_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667869);
    ReadFileOptionsInternal.NativeMethodInfoPtr_set_ReadChunkLengthBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667870);
    ReadFileOptionsInternal.NativeMethodInfoPtr_get_ReadFileDataCallback_Public_Static_get_OnReadFileDataCallbackInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667871);
    ReadFileOptionsInternal.NativeMethodInfoPtr_get_FileTransferProgressCallback_Public_Static_get_OnFileTransferProgressCallbackInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667872);
    ReadFileOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_ReadFileOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667873);
    ReadFileOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667874);
    ReadFileOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileOptionsInternal>.NativeClassPtr, 100667875);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 385145, XrefRangeEnd = 385149, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 385149, XrefRangeEnd = 385153, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 385164, RefRangeEnd = 385166, XrefRangeStart = 385153, XrefRangeEnd = 385164, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
  ...
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 385177, RefRangeEnd = 385179, XrefRangeStart = 385166, XrefRangeEnd = 385177, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
  ...
  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 385201, RefRangeEnd = 385202, XrefRangeStart = 385179, XrefRangeEnd = 385201, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 385202, XrefRangeEnd = 385205, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 385205, XrefRangeEnd = 385212, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
