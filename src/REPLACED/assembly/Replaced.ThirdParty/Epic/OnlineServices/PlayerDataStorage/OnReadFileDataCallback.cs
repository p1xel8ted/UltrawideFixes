...
public sealed class OnReadFileDataCallback(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (OnReadFileDataCallback));
    OnReadFileDataCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100667717);
    OnReadFileDataCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_ReadResult_ReadFileDataCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100667718);
    OnReadFileDataCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_ReadFileDataCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100667719);
    OnReadFileDataCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_ReadResult_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallback>.NativeClassPtr, 100667720);
  }

  [CallerCount(19)]
  [CachedScanResults(RefRangeStart = 374785, RefRangeEnd = 374804, XrefRangeStart = 374785, XrefRangeEnd = 374804, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
