...
public struct CopyFileMetadataByFilenameOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.PlayerDataStorage", nameof (CopyFileMetadataByFilenameOptionsInternal));
    ...
    CopyFileMetadataByFilenameOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr, 100667531);
    CopyFileMetadataByFilenameOptionsInternal.NativeMethodInfoPtr_set_Filename_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr, 100667532);
    CopyFileMetadataByFilenameOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_CopyFileMetadataByFilenameOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr, 100667533);
    CopyFileMetadataByFilenameOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr, 100667534);
    CopyFileMetadataByFilenameOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CopyFileMetadataByFilenameOptionsInternal>.NativeClassPtr, 100667535);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384024, XrefRangeEnd = 384028, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384028, XrefRangeEnd = 384032, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 384040, RefRangeEnd = 384041, XrefRangeStart = 384032, XrefRangeEnd = 384040, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384041, XrefRangeEnd = 384044, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 384044, XrefRangeEnd = 384049, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
