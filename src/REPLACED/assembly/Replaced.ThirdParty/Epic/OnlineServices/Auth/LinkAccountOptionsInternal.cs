...
public struct LinkAccountOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Auth", nameof (LinkAccountOptionsInternal));
    ...
    LinkAccountOptionsInternal.NativeMethodInfoPtr_set_LinkAccountFlags_Public_set_Void_LinkAccountFlags_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672135);
    LinkAccountOptionsInternal.NativeMethodInfoPtr_set_ContinuanceToken_Public_set_Void_ContinuanceToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672136);
    LinkAccountOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_EpicAccountId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672137);
    LinkAccountOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_LinkAccountOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672138);
    LinkAccountOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672139);
    LinkAccountOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LinkAccountOptionsInternal>.NativeClassPtr, 100672140);
  }
  ...
  public unsafe LinkAccountFlags LinkAccountFlags
  {
    [CallerCount(4), CachedScanResults(RefRangeStart = 147707, RefRangeEnd = 147711, XrefRangeStart = 147707, XrefRangeEnd = 147711, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      ...
      System.IntPtr num;
      IL2CPP.il2cpp_runtime_invoke(LinkAccountOptionsInternal.NativeMethodInfoPtr_set_LinkAccountFlags_Public_set_Void_LinkAccountFlags_0, (System.IntPtr) ref this, (void**) numPtr, ref num);
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398669, XrefRangeEnd = 398673, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398673, XrefRangeEnd = 398677, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
        IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value)
      ...
      System.IntPtr num;
      IL2CPP.il2cpp_runtime_invoke(LinkAccountOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_EpicAccountId_0, (System.IntPtr) ref this, (void**) numPtr, ref num);
      Il2CppException.RaiseExceptionIfNecessary(num);
    }
  }

  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 398685, RefRangeEnd = 398686, XrefRangeStart = 398677, XrefRangeEnd = 398685, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398686, XrefRangeEnd = 398689, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398689, XrefRangeEnd = 398694, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
