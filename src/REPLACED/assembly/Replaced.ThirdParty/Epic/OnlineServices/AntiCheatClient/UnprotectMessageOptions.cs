...
public class UnprotectMessageOptions(System.IntPtr pointer) : Il2CppSystem.Object(pointer)
{
  ...
  {
    Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.AntiCheatClient", nameof (UnprotectMessageOptions));
    ...
    UnprotectMessageOptions.NativeMethodInfoPtr_get_Data_Public_get_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr, 100673171);
    UnprotectMessageOptions.NativeMethodInfoPtr_set_Data_Public_set_Void_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr, 100673172);
    UnprotectMessageOptions.NativeMethodInfoPtr_get_OutBufferSizeBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr, 100673173);
    UnprotectMessageOptions.NativeMethodInfoPtr_set_OutBufferSizeBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr, 100673174);
    UnprotectMessageOptions.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptions>.NativeClassPtr, 100673175);
  }
