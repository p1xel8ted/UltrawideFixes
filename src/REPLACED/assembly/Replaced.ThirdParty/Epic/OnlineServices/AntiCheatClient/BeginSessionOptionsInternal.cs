...
public struct BeginSessionOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.AntiCheatClient", nameof (BeginSessionOptionsInternal));
    ...
    BeginSessionOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr, 100673059);
    BeginSessionOptionsInternal.NativeMethodInfoPtr_set_Mode_Public_set_Void_AntiCheatClientMode_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr, 100673060);
    BeginSessionOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_BeginSessionOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr, 100673061);
    BeginSessionOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr, 100673062);
    BeginSessionOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<BeginSessionOptionsInternal>.NativeClassPtr, 100673063);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 401329, XrefRangeEnd = 401333, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  public unsafe AntiCheatClientMode Mode
  {
    [CallerCount(6), CachedScanResults(RefRangeStart = 64574, RefRangeEnd = 64580, XrefRangeStart = 64574, XrefRangeEnd = 64580, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      ...
      System.IntPtr num;
      IL2CPP.il2cpp_runtime_invoke(BeginSessionOptionsInternal.NativeMethodInfoPtr_set_Mode_Public_set_Void_AntiCheatClientMode_0, (System.IntPtr) ref this, (void**) numPtr, ref num);
      Il2CppException.RaiseExceptionIfNecessary(num);
    }
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 401333, XrefRangeEnd = 401337, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 401337, XrefRangeEnd = 401343, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 401343, XrefRangeEnd = 401347, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
