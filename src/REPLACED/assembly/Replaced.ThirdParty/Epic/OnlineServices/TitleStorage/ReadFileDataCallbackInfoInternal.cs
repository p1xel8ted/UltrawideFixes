...
public struct ReadFileDataCallbackInfoInternal
{
  ...
  {
    Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.TitleStorage", nameof (ReadFileDataCallbackInfoInternal));
    ...
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_ClientData_Public_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665064);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_ClientDataAddress_Public_Virtual_Final_New_get_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665065);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665066);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_Filename_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665067);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_TotalFileSizeBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665068);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_IsLastChunk_Public_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665069);
    ReadFileDataCallbackInfoInternal.NativeMethodInfoPtr_get_DataChunk_Public_get_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ReadFileDataCallbackInfoInternal>.NativeClassPtr, 100665070);
  }

  public unsafe Il2CppSystem.Object ClientData
  {
    [CallerCount(1), CachedScanResults(RefRangeStart = 375125, RefRangeEnd = 375126, XrefRangeStart = 375116, XrefRangeEnd = 375125, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 375126, XrefRangeEnd = 375132, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 375132, XrefRangeEnd = 375136, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 375136, XrefRangeEnd = 375142, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 375142, XrefRangeEnd = 375148, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] get
    {
      System.IntPtr* numPtr = (System.IntPtr*) null;
      System.IntPtr num1;
