...
public struct QueryFileOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.TitleStorage", nameof (QueryFileOptionsInternal));
    ...
    QueryFileOptionsInternal.NativeMethodInfoPtr_set_LocalUserId_Public_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr, 100665026);
    QueryFileOptionsInternal.NativeMethodInfoPtr_set_Filename_Public_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr, 100665027);
    QueryFileOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_QueryFileOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr, 100665028);
    QueryFileOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr, 100665029);
    QueryFileOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<QueryFileOptionsInternal>.NativeClassPtr, 100665030);
  }

  public unsafe ProductUserId LocalUserId
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374968, XrefRangeEnd = 374974, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  {
    [CallerCount(0), CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374974, XrefRangeEnd = 374978, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  [CallerCount(1)]
  [CachedScanResults(RefRangeStart = 374988, RefRangeEnd = 374989, XrefRangeStart = 374978, XrefRangeEnd = 374988, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374989, XrefRangeEnd = 374992, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374992, XrefRangeEnd = 375003, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
