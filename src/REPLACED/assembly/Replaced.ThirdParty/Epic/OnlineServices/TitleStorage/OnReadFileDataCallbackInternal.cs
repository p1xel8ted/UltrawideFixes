...
public sealed class OnReadFileDataCallbackInternal(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.TitleStorage", nameof (OnReadFileDataCallbackInternal));
    OnReadFileDataCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100664976 /*0x06000690*/);
    OnReadFileDataCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_ReadResult_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100664977);
    OnReadFileDataCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_IntPtr_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100664978);
    OnReadFileDataCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_ReadResult_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnReadFileDataCallbackInternal>.NativeClassPtr, 100664979);
  }

  [CallerCount(12)]
  [CachedScanResults(RefRangeStart = 374809, RefRangeEnd = 374821, XrefRangeStart = 374807, XrefRangeEnd = 374809, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
