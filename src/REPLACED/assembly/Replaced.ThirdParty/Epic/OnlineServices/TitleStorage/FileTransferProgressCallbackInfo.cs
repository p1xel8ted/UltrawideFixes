...
// Type: Epic.OnlineServices.TitleStorage.FileTransferProgressCallbackInfo
...
public class FileTransferProgressCallbackInfo(System.IntPtr pointer) : Il2CppSystem.Object(pointer)
{
  ...
  {
    Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.TitleStorage", nameof (FileTransferProgressCallbackInfo));
    ...
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_get_ClientData_Public_Virtual_Final_New_get_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664905);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_set_ClientData_Private_set_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664906);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_get_LocalUserId_Public_get_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664907);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_set_LocalUserId_Private_set_Void_ProductUserId_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664908);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_get_Filename_Public_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664909);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_set_Filename_Private_set_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664910);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_get_BytesTransferred_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664911);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_set_BytesTransferred_Private_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664912 /*0x06000650*/);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_get_TotalFileSizeBytes_Public_get_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664913);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_set_TotalFileSizeBytes_Private_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664914);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_GetResultCode_Public_Virtual_Final_New_Nullable_1_Result_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664915);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_Set_Internal_Void_Nullable_1_FileTransferProgressCallbackInfoInternal_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664916);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664917);
    FileTransferProgressCallbackInfo.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FileTransferProgressCallbackInfo>.NativeClassPtr, 100664918);
  }
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374682, XrefRangeEnd = 374705, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 374705, XrefRangeEnd = 374732, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
