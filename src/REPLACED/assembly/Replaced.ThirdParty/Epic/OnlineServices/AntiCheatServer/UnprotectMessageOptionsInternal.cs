...
public struct UnprotectMessageOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.AntiCheatServer", nameof (UnprotectMessageOptionsInternal));
    ...
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_set_ClientHandle_Public_set_Void_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672598);
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_set_Data_Public_set_Void_Il2CppStructArray_1_Byte_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672599);
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_set_OutBufferSizeBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672600);
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_UnprotectMessageOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672601);
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672602);
    UnprotectMessageOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<UnprotectMessageOptionsInternal>.NativeClassPtr, 100672603);
  }
  ...
  public unsafe System.IntPtr ClientHandle
  {
    [CallerCount(0)] set
    {
      ...
      System.IntPtr num;
      IL2CPP.il2cpp_runtime_invoke(UnprotectMessageOptionsInternal.NativeMethodInfoPtr_set_ClientHandle_Public_set_Void_IntPtr_0, (System.IntPtr) ref this, (void**) numPtr, ref num);
  ...
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 399877, RefRangeEnd = 399879, XrefRangeStart = 399871, XrefRangeEnd = 399877, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 399879, XrefRangeEnd = 399880, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 399880, XrefRangeEnd = 399883, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 399883, XrefRangeEnd = 399888, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
