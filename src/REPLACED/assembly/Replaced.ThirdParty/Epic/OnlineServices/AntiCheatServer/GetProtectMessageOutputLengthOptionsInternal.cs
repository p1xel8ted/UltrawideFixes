...
// Type: Epic.OnlineServices.AntiCheatServer.GetProtectMessageOutputLengthOptionsInternal
...
public struct GetProtectMessageOutputLengthOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.AntiCheatServer", nameof (GetProtectMessageOutputLengthOptionsInternal));
    ...
    GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_set_DataLengthBytes_Public_set_Void_UInt32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100672511);
    GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_GetProtectMessageOutputLengthOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100672512 /*0x06002400*/);
    GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100672513);
    GetProtectMessageOutputLengthOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetProtectMessageOutputLengthOptionsInternal>.NativeClassPtr, 100672514);
  }
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 399791, XrefRangeEnd = 399793, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
