...
// Type: Epic.OnlineServices.Connect.OnLinkAccountCallback
...
public sealed class OnLinkAccountCallback(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnLinkAccountCallback>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Connect", nameof (OnLinkAccountCallback));
    OnLinkAccountCallback.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallback>.NativeClassPtr, 100671774);
    OnLinkAccountCallback.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_LinkAccountCallbackInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallback>.NativeClassPtr, 100671775);
    OnLinkAccountCallback.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_LinkAccountCallbackInfo_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallback>.NativeClassPtr, 100671776);
    OnLinkAccountCallback.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnLinkAccountCallback>.NativeClassPtr, 100671777);
  }
