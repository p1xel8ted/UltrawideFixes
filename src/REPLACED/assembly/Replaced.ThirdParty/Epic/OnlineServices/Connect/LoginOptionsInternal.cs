...
public struct LoginOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Connect", nameof (LoginOptionsInternal));
    ...
    LoginOptionsInternal.NativeMethodInfoPtr_set_Credentials_Public_set_Void_Credentials_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr, 100671720);
    LoginOptionsInternal.NativeMethodInfoPtr_set_UserLoginInfo_Public_set_Void_UserLoginInfo_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr, 100671721);
    LoginOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_LoginOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr, 100671722);
    LoginOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr, 100671723);
    LoginOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<LoginOptionsInternal>.NativeClassPtr, 100671724);
  }

  public unsafe Credentials Credentials
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 397471, RefRangeEnd = 397473, XrefRangeStart = 397465, XrefRangeEnd = 397471, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 397479, RefRangeEnd = 397481, XrefRangeStart = 397473, XrefRangeEnd = 397479, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
      System.IntPtr* numPtr = stackalloc System.IntPtr[1]
      {
        IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value)
      ...
      System.IntPtr num;
      IL2CPP.il2cpp_runtime_invoke(LoginOptionsInternal.NativeMethodInfoPtr_set_UserLoginInfo_Public_set_Void_UserLoginInfo_0, (System.IntPtr) ref this, (void**) numPtr, ref num);
      Il2CppException.RaiseExceptionIfNecessary(num);
    }
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 397481, XrefRangeEnd = 397483, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 397483, XrefRangeEnd = 397487, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 397487, XrefRangeEnd = 397492, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
