...
public class VerifyIdTokenOptions(System.IntPtr pointer) : Il2CppSystem.Object(pointer)
{
  ...
  {
    Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Connect", nameof (VerifyIdTokenOptions));
    ...
    VerifyIdTokenOptions.NativeMethodInfoPtr_get_IdToken_Public_get_IdToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr, 100671991);
    VerifyIdTokenOptions.NativeMethodInfoPtr_set_IdToken_Public_set_Void_IdToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr, 100671992);
    VerifyIdTokenOptions.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptions>.NativeClassPtr, 100671993);
  }
