...
public struct VerifyIdTokenOptionsInternal
{
  ...
  {
    Il2CppClassPointerStore<VerifyIdTokenOptionsInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Connect", nameof (VerifyIdTokenOptionsInternal));
    ...
    VerifyIdTokenOptionsInternal.NativeMethodInfoPtr_set_IdToken_Public_set_Void_IdToken_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptionsInternal>.NativeClassPtr, 100671994);
    VerifyIdTokenOptionsInternal.NativeMethodInfoPtr_Set_Public_Void_VerifyIdTokenOptions_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptionsInternal>.NativeClassPtr, 100671995);
    VerifyIdTokenOptionsInternal.NativeMethodInfoPtr_Set_Public_Virtual_Final_New_Void_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptionsInternal>.NativeClassPtr, 100671996);
    VerifyIdTokenOptionsInternal.NativeMethodInfoPtr_Dispose_Public_Virtual_Final_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VerifyIdTokenOptionsInternal>.NativeClassPtr, 100671997);
  }

  public unsafe IdToken IdToken
  {
    [CallerCount(2), CachedScanResults(RefRangeStart = 398035, RefRangeEnd = 398037, XrefRangeStart = 398029, XrefRangeEnd = 398035, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)] set
    {
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398037, XrefRangeEnd = 398038, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398038, XrefRangeEnd = 398041, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 398041, XrefRangeEnd = 398045, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
