...
// Type: Epic.OnlineServices.Connect.OnCreateUserCallbackInternal
...
public sealed class OnCreateUserCallbackInternal(System.IntPtr pointer) : Il2CppSystem.MulticastDelegate(pointer)
{
  ...
  {
    Il2CppClassPointerStore<OnCreateUserCallbackInternal>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "Epic.OnlineServices.Connect", nameof (OnCreateUserCallbackInternal));
    OnCreateUserCallbackInternal.NativeMethodInfoPtr__ctor_Public_Void_Object_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallbackInternal>.NativeClassPtr, 100671762);
    OnCreateUserCallbackInternal.NativeMethodInfoPtr_Invoke_Public_Virtual_New_Void_IntPtr_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallbackInternal>.NativeClassPtr, 100671763);
    OnCreateUserCallbackInternal.NativeMethodInfoPtr_BeginInvoke_Public_Virtual_New_IAsyncResult_IntPtr_AsyncCallback_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallbackInternal>.NativeClassPtr, 100671764);
    OnCreateUserCallbackInternal.NativeMethodInfoPtr_EndInvoke_Public_Virtual_New_Void_IAsyncResult_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OnCreateUserCallbackInternal>.NativeClassPtr, 100671765);
  }
