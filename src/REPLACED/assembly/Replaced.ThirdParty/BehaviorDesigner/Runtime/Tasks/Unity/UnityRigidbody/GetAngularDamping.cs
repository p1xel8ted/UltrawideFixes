...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody.GetAngularDamping
...
public class GetAngularDamping(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  {
    Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody", nameof (GetAngularDamping));
    ...
    GetAngularDamping.NativeFieldInfoPtr_rigidbody = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr, nameof (rigidbody));
    ...
    GetAngularDamping.NativeMethodInfoPtr_OnStart_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr, 100674566);
    GetAngularDamping.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr, 100674567);
    GetAngularDamping.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr, 100674568);
    GetAngularDamping.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetAngularDamping>.NativeClassPtr, 100674569);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 407948, XrefRangeEnd = 407959, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 407959, XrefRangeEnd = 407969, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe Rigidbody rigidbody
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(GetAngularDamping.NativeFieldInfoPtr_rigidbody));
      return num == IntPtr.Zero ? (Rigidbody) null : Il2CppObjectPool.Get<Rigidbody>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(GetAngularDamping.NativeFieldInfoPtr_rigidbody), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
