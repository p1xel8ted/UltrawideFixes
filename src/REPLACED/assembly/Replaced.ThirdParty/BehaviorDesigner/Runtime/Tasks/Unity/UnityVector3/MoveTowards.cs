...
public class MoveTowards(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  static MoveTowards()
  {
    Il2CppClassPointerStore<MoveTowards>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3", nameof (MoveTowards));
    ...
    MoveTowards.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MoveTowards>.NativeClassPtr, 100674056);
    MoveTowards.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MoveTowards>.NativeClassPtr, 100674057);
    MoveTowards.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MoveTowards>.NativeClassPtr, 100674058);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405347, XrefRangeEnd = 405365, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405365, XrefRangeEnd = 405390, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe SharedVector3 currentPosition
  {
    get
    {
