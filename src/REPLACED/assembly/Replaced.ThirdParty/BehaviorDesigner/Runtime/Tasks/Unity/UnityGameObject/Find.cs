...
{
  private static readonly IntPtr NativeFieldInfoPtr_gameObjectName;
  ...
  static Find()
  {
    Il2CppClassPointerStore<Find>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityGameObject", nameof (Find));
    IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Find>.NativeClassPtr);
    Find.NativeFieldInfoPtr_gameObjectName = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Find>.NativeClassPtr, nameof (gameObjectName));
    Find.NativeFieldInfoPtr_storeValue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Find>.NativeClassPtr, nameof (storeValue));
    Find.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Find>.NativeClassPtr, 100675082);
    Find.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Find>.NativeClassPtr, 100675083);
    Find.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Find>.NativeClassPtr, 100675084);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 410437, XrefRangeEnd = 410451, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe SharedString gameObjectName
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(Find.NativeFieldInfoPtr_gameObjectName));
      return num == IntPtr.Zero ? (SharedString) null : Il2CppObjectPool.Get<SharedString>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(Find.NativeFieldInfoPtr_gameObjectName), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
