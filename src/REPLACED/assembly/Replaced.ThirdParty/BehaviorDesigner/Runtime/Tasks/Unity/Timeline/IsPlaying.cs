...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.Timeline.IsPlaying
...
public class IsPlaying(IntPtr pointer) : Conditional(pointer)
{
  ...
  static IsPlaying()
  {
    Il2CppClassPointerStore<IsPlaying>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.Timeline", nameof (IsPlaying));
    ...
    IsPlaying.NativeFieldInfoPtr_playableDirector = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<IsPlaying>.NativeClassPtr, nameof (playableDirector));
    ...
    IsPlaying.NativeMethodInfoPtr_OnStart_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IsPlaying>.NativeClassPtr, 100674253);
    IsPlaying.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IsPlaying>.NativeClassPtr, 100674254);
    IsPlaying.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IsPlaying>.NativeClassPtr, 100674255);
    IsPlaying.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IsPlaying>.NativeClassPtr, 100674256);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 406535, XrefRangeEnd = 406546, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 406546, XrefRangeEnd = 406553, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe PlayableDirector playableDirector
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(IsPlaying.NativeFieldInfoPtr_playableDirector));
      return num == IntPtr.Zero ? (PlayableDirector) null : Il2CppObjectPool.Get<PlayableDirector>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(IsPlaying.NativeFieldInfoPtr_playableDirector), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
