...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityBehaviour.SetEnabled
...
public class SetEnabled(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  static SetEnabled()
  {
    Il2CppClassPointerStore<SetEnabled>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityBehaviour", nameof (SetEnabled));
    IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SetEnabled>.NativeClassPtr);
    SetEnabled.NativeFieldInfoPtr_specifiedObject = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SetEnabled>.NativeClassPtr, nameof (specifiedObject));
    ...
    SetEnabled.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SetEnabled>.NativeClassPtr, 100675268);
    SetEnabled.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SetEnabled>.NativeClassPtr, 100675269);
    SetEnabled.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SetEnabled>.NativeClassPtr, 100675270);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 411441, XrefRangeEnd = 411450, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 411450, XrefRangeEnd = 411454, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe SharedBehaviour specifiedObject
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(SetEnabled.NativeFieldInfoPtr_specifiedObject));
      return num == IntPtr.Zero ? (SharedBehaviour) null : Il2CppObjectPool.Get<SharedBehaviour>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(SetEnabled.NativeFieldInfoPtr_specifiedObject), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
