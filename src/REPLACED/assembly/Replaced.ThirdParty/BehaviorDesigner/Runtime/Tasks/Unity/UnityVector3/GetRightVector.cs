...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3.GetRightVector
...
public class GetRightVector(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  {
    Il2CppClassPointerStore<GetRightVector>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3", nameof (GetRightVector));
    ...
    GetRightVector.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetRightVector>.NativeClassPtr, 100674038);
    GetRightVector.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetRightVector>.NativeClassPtr, 100674039);
    GetRightVector.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetRightVector>.NativeClassPtr, 100674040);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405268, XrefRangeEnd = 405273, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
