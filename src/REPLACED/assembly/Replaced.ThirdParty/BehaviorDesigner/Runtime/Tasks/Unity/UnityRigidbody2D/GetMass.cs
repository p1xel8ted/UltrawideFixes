...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D.GetMass
...
public class GetMass(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  static GetMass()
  {
    Il2CppClassPointerStore<GetMass>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityRigidbody2D", nameof (GetMass));
    ...
    GetMass.NativeFieldInfoPtr_rigidbody2D = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GetMass>.NativeClassPtr, nameof (rigidbody2D));
    ...
    GetMass.NativeMethodInfoPtr_OnStart_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetMass>.NativeClassPtr, 100674474);
    GetMass.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetMass>.NativeClassPtr, 100674475);
    GetMass.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetMass>.NativeClassPtr, 100674476);
    GetMass.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetMass>.NativeClassPtr, 100674477);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 407456, XrefRangeEnd = 407467, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 407467, XrefRangeEnd = 407477, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe Rigidbody2D rigidbody2D
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(GetMass.NativeFieldInfoPtr_rigidbody2D));
      return num == IntPtr.Zero ? (Rigidbody2D) null : Il2CppObjectPool.Get<Rigidbody2D>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(GetMass.NativeFieldInfoPtr_rigidbody2D), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
