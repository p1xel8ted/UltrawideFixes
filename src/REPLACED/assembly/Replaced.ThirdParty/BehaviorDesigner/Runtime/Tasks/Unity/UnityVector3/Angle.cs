...
// Type: BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3.Angle
...
public class Angle(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  static Angle()
  {
    Il2CppClassPointerStore<Angle>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3", nameof (Angle));
    IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<Angle>.NativeClassPtr);
    Angle.NativeFieldInfoPtr_firstVector3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Angle>.NativeClassPtr, nameof (firstVector3));
    Angle.NativeFieldInfoPtr_secondVector3 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<Angle>.NativeClassPtr, nameof (secondVector3));
    ...
    Angle.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Angle>.NativeClassPtr, 100674020);
    Angle.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Angle>.NativeClassPtr, 100674021);
    Angle.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<Angle>.NativeClassPtr, 100674022);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405157, XrefRangeEnd = 405166, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405166, XrefRangeEnd = 405183, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe SharedVector3 firstVector3
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(Angle.NativeFieldInfoPtr_firstVector3));
      return num == IntPtr.Zero ? (SharedVector3) null : Il2CppObjectPool.Get<SharedVector3>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(Angle.NativeFieldInfoPtr_firstVector3), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
  ...
  public unsafe SharedVector3 secondVector3
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(Angle.NativeFieldInfoPtr_secondVector3));
      return num == IntPtr.Zero ? (SharedVector3) null : Il2CppObjectPool.Get<SharedVector3>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(Angle.NativeFieldInfoPtr_secondVector3), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
