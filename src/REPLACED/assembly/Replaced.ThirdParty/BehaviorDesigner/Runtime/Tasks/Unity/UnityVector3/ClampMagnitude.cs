...
public class ClampMagnitude(IntPtr pointer) : BehaviorDesigner.Runtime.Tasks.Action(pointer)
{
  ...
  {
    Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr = IL2CPP.GetIl2CppClass("Replaced.ThirdParty.dll", "BehaviorDesigner.Runtime.Tasks.Unity.UnityVector3", nameof (ClampMagnitude));
    IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr);
    ClampMagnitude.NativeFieldInfoPtr_vector3Variable = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr, nameof (vector3Variable));
    ...
    ClampMagnitude.NativeMethodInfoPtr_OnUpdate_Public_Virtual_TaskStatus_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr, 100674023);
    ClampMagnitude.NativeMethodInfoPtr_OnReset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr, 100674024);
    ClampMagnitude.NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClampMagnitude>.NativeClassPtr, 100674025);
  }

  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405183, XrefRangeEnd = 405197, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  [CallerCount(0)]
  [CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 405197, XrefRangeEnd = 405214, MetadataInitTokenRva = 0, MetadataInitFlagRva = 0)]
  ...
  public unsafe SharedVector3 vector3Variable
  {
    get
    {
      IntPtr num = *(IntPtr*) (IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this) + (int) IL2CPP.il2cpp_field_get_offset(ClampMagnitude.NativeFieldInfoPtr_vector3Variable));
      return num == IntPtr.Zero ? (SharedVector3) null : Il2CppObjectPool.Get<SharedVector3>(num);
    }
    [param: In] set
    {
      IntPtr ptrNotNull = IL2CPP.Il2CppObjectBaseToPtrNotNull((Il2CppObjectBase) this);
      IL2CPP.il2cpp_gc_wbarrier_set_field(ptrNotNull, ptrNotNull + (int) IL2CPP.il2cpp_field_get_offset(ClampMagnitude.NativeFieldInfoPtr_vector3Variable), IL2CPP.Il2CppObjectBaseToPtr((Il2CppObjectBase) value));
    }
  }
