...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        Application.focusChanged += _ => AudioListener.pause = MuteInBackground.Value && !Application.isFocused;
    ...
    private static void UpdateFixedDeltaTime()
    {
        ...
        Log.LogInfo($"Physics update rate set to {Mathf.RoundToInt(1f / Time.fixedDeltaTime)}Hz");
    }
