...
public static class Descriptions
{
    ...
    internal static string GetDescription(string fieldName)
    {
        var descriptions = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "HIDE_DEVELOPER_CONSOLE", "Hides the developer console from the user interface." },
            { "HIDE_MODEL_PREVIEW", "Hides the model preview display in the game." },
            { "SHADER_WARM_UP_VARIANTS_PER_FRAME", "Number of shader variants to warm up per frame during loading." },
            { "PRINT_AUDIO_MANAGER_LOGS", "Enables debug logging for the audio manager system." },
            { "PRINT_CHEAT_MANAGER_LOGS", "Enables debug logging for the cheat manager system." },
            { "PRINT_RAIN_LOGS", "Enables debug logging for rain effects." },
            { "PRINT_HOTPLUG_LOGS", "Enables debug logging for controller hotplug events." },
            { "PRINT_CONTROLLER_MANAGER_LOGS", "Enables debug logging for the controller manager." },
            { "PRINT_SURFACE_MANAGER_LOGS", "Enables debug logging for the surface manager system." },
            { "PRINT_LEVEL_LOADER_LOGS", "Enables debug logging for level loading operations." },
            { "PRINT_GAME_MANAGER_LOGS", "Enables debug logging for the game manager." },
            { "PRINT_TRANSLATIONS_DATABASE_LOGS", "Enables debug logging for the translation database." },
            { "PRINT_VIDEO_PLAYER_LOGS", "Enables debug logging for video playback." },
            { "PRINT_CUTSCENE_LOGS", "Enables debug logging for cutscene events." },
            { "PRINT_INITIALIZATION_MODULE_LOGS", "Enables debug logging for game initialization modules." },
            { "PRINT_GYROSCOPE_CONTROLLER_LOGS", "Enables debug logging for gyroscope controller input." },
            { "PRINT_OBJECT_POOL_LOGS", "Enables debug logging for object pooling system." },
            { "PRINT_VOLUME_LOGS", "Enables debug logging for volume and post-processing." },
            { "PRINT_SAVE_DATA_HANDLER_LOGS", "Enables debug logging for save data operations." },
            { "PRINT_NINTENDO_INPUT_LOGS", "Enables debug logging for Nintendo-specific input handling." },
            { "PRINT_GAMECORE_SAVELOAD_LOGS", "Enables debug logging for core save/load functionality." },
            { "PRINT_GAMECORE_SYSTEM_LOGS", "Enables debug logging for core game systems." },
            ...
            { "SCORE_DEBUG_ENABLED", "Enables debug display for scoring system." },
            { "BEST_ENDING_SCORE_REQUIREMENT", "The score required to achieve the best ending." },
            { "DEFAULT_START_TOKEN_AMOUNT", "The default number of continuation tokens at game start." },
            ...
            { "ENABLE_FLASHLIGHT_ON_LEVEL_START", "Automatically enables flashlight when a level starts." },
            ...
            { "DISABLE_ENEMY_GRUNTS", "Disables enemy grunt sound effects." },
            ...
            { "ARE_ALL_CHEATS_ENABLED", "Enables all cheat codes." },
            ...
            { "ONE_SHOT_BOSS_ACTIVE", "Enables one-shot kills on boss enemies." },
            { "FIGHT_ALL_BOSSES_IN_BOSS_MODE", "Forces all boss encounters in boss rush mode." },
            { "CACHED_BOSS_FIGHT_TIME", "Cached time for boss fight duration tracking." },
            { "PAGE_DISPLAY_TIME", "The display time for each page during transitions." }
        };

        return descriptions.GetValueOrDefault(fieldName, "No description available.");
    }
}