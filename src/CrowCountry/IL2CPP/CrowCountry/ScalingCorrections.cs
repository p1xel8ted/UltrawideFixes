...
{
    private static readonly Dictionary<RectTransform, WriteOnceVector3> MapScales = new();
    private static readonly WriteOnceFloat CreditsSkyY = new();


    internal static readonly WriteOnceVector3 PoisonScale = new();

    private static readonly WriteOnceFloat CreditsHeaderFooterX = new();
    private static readonly WriteOnceFloat CreditsBackgroundX = new();
    private static readonly WriteOnceFloat CreditsTransitionX = new();

    private static readonly WriteOnceFloat PauseScreenBackgroundX = new();
    ...
    private static readonly WriteOnceFloat DrivingRoadX = new();
    private static readonly WriteOnceFloat DrivingRoadZ = new();
    ...
    internal static void CorrectMapBackground()
    {
        ...
        foreach (var rt in rectTransforms)
        {
            ...
            {
                originalScale = new WriteOnceVector3 {Value = rt.localScale};
    ...
    private static readonly WriteOnceFloat FooterX = new();
