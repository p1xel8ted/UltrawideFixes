...
public class MessageDisplayer : MonoBehaviour
{
    ...
    public void ShowMessage(string message, float duration = 2f, Corner corner = Corner.TopRight, int fontSize = 24, Color? color = null)
    {
        ...
        var bg = messageObject.AddComponent<Image>();
        ...
        var hlg = messageObject.AddComponent<HorizontalLayoutGroup>();
        hlg.padding = new RectOffset(8, 8, 4, 4);
        hlg.childAlignment = corner switch
        {
        ...
        textObject.transform.SetParent(messageObject.transform);
        ...
        // Match pivot to corner so the background expands inward
        var pivot = corner switch
        {
