...
using YasukeSimulator.Misc;

namespace YasukeSimulator;

[BepInPlugin(PluginGuid, PluginName, PluginVersion)]
public class Plugin : BaseUnityPlugin
{
    // Plugin Metadata
    private const string PluginGuid = "p1xel8ted.yasukesimulator.uwfixes";
    private const string PluginName = "Yasuke Simulator Ultra-Wide";
    ...
    internal static ConfigEntry<bool> DisableBloodOverlay { get; private set; }
    ...
    private void Awake()
    {
        ...
        SetupGraphicsConfigurations(); //02
        SetupRandomFixConfigurations(); //03
    ...
    private void SetupRandomFixConfigurations()
    {
        DisableBloodOverlay = Config.Bind("04. Random Fixes", "Disable Blood Overlay", false,
            new ConfigDescription(
                "While attempts have been made to correct the fading of the blood overlay, you can enable this option to disable it entirely.",
                null,
