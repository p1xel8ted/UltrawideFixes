...
public static class Resolutions
{
    ...
    /// </summary>
    internal static int MaxRefresh => Screen.resolutions.Max(a => Mathf.RoundToInt(a.refreshRate));
    ...
    {
        var unityRates = Screen.resolutions.Select(a => Mathf.RoundToInt(a.refreshRate)).Distinct().ToArray();
