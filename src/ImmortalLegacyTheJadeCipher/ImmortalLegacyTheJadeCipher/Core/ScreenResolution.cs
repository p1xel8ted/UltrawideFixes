...
public static class ScreenResolution
{
    ...
    /// <summary>
    /// Helper to determine if fullscreen should be enabled based on config
    /// </summary>
    private static bool IsFullScreen =>
        ConfigManager.FullScreenModeConfig.Value == FullScreenMode.ExclusiveFullScreen ||
        ConfigManager.FullScreenModeConfig.Value == FullScreenMode.FullScreenWindow;
        ...
        ref FullScreenMode fullscreenMode)
    {
        width = ChosenResolution.width;
        height = ChosenResolution.height;
        fullscreenMode = ConfigManager.FullScreenModeConfig.Value;
    }
    ...
    {
        value = ConfigManager.FullScreenModeConfig.Value;
    }
}