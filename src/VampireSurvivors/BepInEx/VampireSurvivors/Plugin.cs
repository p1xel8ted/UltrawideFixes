...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        ExpandSpawnZone = Config.Bind("03. Gameplay", "Expand Spawn Zone", true, new ConfigDescription("Expands the spawn zone to fit the new resolution.", null, new ConfigurationManagerAttributes { Order = 92 }));
