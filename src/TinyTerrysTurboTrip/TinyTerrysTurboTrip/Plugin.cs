namespace TinyTerrysTurboTrip;

[BepInPlugin(PluginGuid, PluginName, PluginVersion)]
public class Plugin : BasePlugin
{
    private const string PluginGuid = "p1xel8ted.tinyterrysturbotrip.ultrawide";
    private const string PluginName = "Tiny Terrys Turbo Trip Ultra-Wide";
