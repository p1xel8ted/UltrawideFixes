...
public static class ScreenResolution
{
    ...
    private static bool IsFullScreen => Plugin.FullScreenModeConfig.Value == FullScreenMode.ExclusiveFullScreen ||
    ...
    {
        width = Plugin.SelectedResolution.width;
        height = Plugin.SelectedResolution.height;
